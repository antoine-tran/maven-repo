...
public abstract class StochasticMinimizer<T extends DoubleValuedFunction> implements Minimizer<T>, HasEvaluators
{
  ...
  */
  ...
  public abstract Pair<Integer,Double> tune(DoubleValuedFunction function,double[] initial, long msPerTest);

  public double tuneDouble(edu.stanford.nlp.optimization.DoubleValuedFunction function, double[] initial, long msPerTest,PropertySetter<Double> ps,double lower,double upper){
    return this.tuneDouble(function, initial, msPerTest, ps, lower, upper, 1e-3*Math.abs(upper-lower));
  }

public double tuneDouble(edu.stanford.nlp.optimization.DoubleValuedFunction function, double[] initial, long msPerTest,PropertySetter<Double> ps,double lower,double upper,double TOL){
  ...
  public Pair<Integer,Double> tune(DoubleValuedFunction function, double[] initial, long msPerTest,List<Integer> batchSizes, List<Double> gains){
