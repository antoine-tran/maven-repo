...
/**
 * This class refactors the class PairOfStringInt of Jimmy
...
public class StringIntPairWritable implements WritableComparable<StringIntPairWritable>{
	 ...
	 */
	public StringIntPairWritable(String left, int right) {
		set(left, right);
	}
	...
	public boolean equals(Object obj) {
		StringIntPairWritable pair = (StringIntPairWritable) obj;
	 ...
	 *         <code>obj</code>.
	 */
	public int compareTo(StringIntPairWritable pair) {
	 ...
	 */
	public StringIntPairWritable clone() {
		return new StringIntPairWritable(this.leftElement, this.rightElement);
	}

	/** Comparator optimized for <code>StringIntPairWritable</code>. */
	...
	static { // register this comparator
		WritableComparator.define(StringIntPairWritable.class, new Comparator());
	}
}
