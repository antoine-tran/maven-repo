...
public class Word {
	...
	// List of stop words
	private static final String[] stopList = new String[] {
			...
			"but","by","c","c'mon","c's","came","can","can't","cannot",
			...
			"described","despite","did","didn't","different","do","does",
			"doesn't","doing","don't","done","down","downwards","during","e",
			...
			"it's","its","itself","j","just","k","keep","keeps","kept","know",
			"knows","known","l","last","lately","later","latter","latterly",
			"least","less","lest","let","let's","like","liked","likely",
			"little","look","looking","looks","ltd","m","mainly","many","may",
			...
			"still","sub","such","sup","sure","t","t's","take","taken","tell",
			...
			"truly","try","trying","twice","two","u","un","under",
