 ...
 * number small.
 * 
 * <br><i>Tuan's note:</i> That's not true, there is also overheads per
 * object depending on JVM implementations (~ 40 bytes), so this consumes
 * 136 bytes (32-bit JVM) / 152 bytes (64-bit JVM)
 *
 * @author Dan Klein
