...
public class FloatArrayList {
	...
	public FloatArrayList (boolean ordered, int capacity) {
	 ...
	 * grown. */
	public FloatArrayList (FloatArrayList array) {
	 ...
	 * @param ordered If false, methods that remove elements may change the order of other elements in the array, which avoids a
	 *           memory copy. */
	public FloatArrayList (boolean ordered, float[] array) {
	...
	public void addAll (FloatArrayList array) {
		addAll(array, 0, array.size);
	}

	public void addAll (FloatArrayList array, int offset, int length) {
